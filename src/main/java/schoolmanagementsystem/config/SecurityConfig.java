...
import schoolmanagementsystem.security.JwtAuthenticationFilter;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                .csrf(csrf -> csrf.disable())  // ✅ Fixed deprecated CSRF config
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/api/v1/auth/**").permitAll() // ✅ Fixed matcher
                        .requestMatchers("/api/v1/admin/**").hasAuthority("ADMIN") // ✅ Changed `hasRole` to `hasAuthority`
